...
import { OrdersSectionSkeleton } from "./skeleton";
...
export function OrderReportSection({ dateRange }: OrderReportSectionProps) {
  ...
  const [performanceMetrics, setPerformanceMetrics] =
    useState<OrderPerformanceMetrics | null>(null);
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="p-4 bg-gray-50 rounded-lg">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {performanceMetrics?.peak_day_count
                      ? `${performanceMetrics.peak_day_count} orders`
