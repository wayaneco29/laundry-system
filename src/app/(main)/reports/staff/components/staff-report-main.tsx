...
import { Calendar, Download, Users, TrendingUp, Package, DollarSign } from 'lucide-react';
import { useUserContext } from '@/app/context/UserContext';
import { getStaffSalesReport, getActiveStaffShift } from '@/app/actions/staff/shift_actions';
  ...
  const handleExportReport = async () => {
    ...
    try {
      ...
      if (link.download !== undefined) {
        ...
        link.setAttribute('download', `staff-report-${reportData.staff_name}-${selectedDate}.csv`);
    ...
    return (
      <div className="bg-white rounded-lg shadow-sm p-6 text-center">
        ...
        <p className="text-gray-600">
          Staff reports are only available for staff members. Admins can view overall performance in the main reports section.
        </p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{formatCurrency(reportData.total_sales)}</p>
                </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-green-600">{formatCurrency(reportData.commission_amount)}</p>
                </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900 truncate" title={reportData.partner_name}>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">{formatCurrency(reportData.cash_sales)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">GCash Payments</span>
                  <span className="font-semibold">{formatCurrency(reportData.gcash_sales)}</span>
                </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">{formatCurrency(reportData.total_sales)}</span>
                </div>
                <div className="border-t pt-2">
          ...
          <div className="p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Inventory Usage</h3>
            </div>
            
            {reportData.inventory_usage && reportData.inventory_usage.length > 0 ? (
              <div className="overflow-x-auto">
                <table className="min-w-full table-auto">
                  <thead>
                    <tr className="border-b border-gray-200">
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600">Item</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600">Quantity Used</th>
                      <th className="px-4 py-2 text-left text-sm font-medium text-gray-600">Time Used</th>
                    </tr>
                  </thead>
                  <tbody>
                    {reportData.inventory_usage.map((item, index) => (
                      <tr key={index} className="border-b border-gray-100">
                        <td className="px-4 py-2 text-sm text-gray-900">{item.stock_name}</td>
                        <td className="px-4 py-2 text-sm text-gray-600">{item.quantity_used}</td>
        ...
        <div className="p-8 text-center">
          ...
          <p className="text-gray-600">
            No sales data found for {new Date(selectedDate).toLocaleDateString()}. 
            {isToday ? ' Start your shift to begin tracking sales!' : ' Try selecting a different date.'}
          </p>
        </div>
      )}
    </div>
