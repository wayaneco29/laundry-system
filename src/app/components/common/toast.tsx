...
export function ToastComponent({ toast, onRemove }: ToastComponentProps) {
  ...
  const getToastStyles = () => {
    const baseStyles = "flex items-center p-4 rounded-lg shadow-lg max-w-md w-full transform transition-all duration-300 ease-in-out";
  ...
  return (
    <div className={getToastStyles()}>
      ...
      <button
        ...
        className="ml-3 flex-shrink-0 rounded-full p-1 hover:bg-black/10 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-current"
      >
